...
final class SpdyCodecUtil {
    ...
    public static int getUnsignedShort(ByteBuf buf, int offset) {
        return ((buf.getByte(offset) & 255) << 8) | (buf.getByte(offset + 1) & 255);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getUnsignedMedium(ByteBuf buf, int offset) {
        return ((buf.getByte(offset) & 255) << 16) | ((buf.getByte(offset + 1) & 255) << 8) | (buf.getByte(offset + 2) & 255);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getUnsignedInt(ByteBuf buf, int offset) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getSignedInt(ByteBuf buf, int offset) {
        return ((buf.getByte(offset) & 255) << 24) | ((buf.getByte(offset + 1) & 255) << 16) | ((buf.getByte(offset + 2) & 255) << 8) | (buf.getByte(offset + 3) & 255);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean isServerId(int id) {
        return id % 2 == 0;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void validateHeaderName(CharSequence name) {
