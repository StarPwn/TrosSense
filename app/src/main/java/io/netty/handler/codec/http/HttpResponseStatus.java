...
public class HttpResponseStatus implements Comparable<HttpResponseStatus> {
    ...
    public static final HttpResponseStatus CREATED = newStatus(bl.cz, "Created");
    public static final HttpResponseStatus ACCEPTED = newStatus(bl.cA, "Accepted");
    public static final HttpResponseStatus NON_AUTHORITATIVE_INFORMATION = newStatus(bl.cB, "Non-Authoritative Information");
    public static final HttpResponseStatus NO_CONTENT = newStatus(bl.cC, "No Content");
    public static final HttpResponseStatus RESET_CONTENT = newStatus(bl.cD, "Reset Content");
    public static final HttpResponseStatus PARTIAL_CONTENT = newStatus(bl.cE, "Partial Content");
    public static final HttpResponseStatus MULTI_STATUS = newStatus(bl.cF, "Multi-Status");
    public static final HttpResponseStatus MULTIPLE_CHOICES = newStatus(300, "Multiple Choices");
    public static final HttpResponseStatus MOVED_PERMANENTLY = newStatus(bl.ea, "Moved Permanently");
    public static final HttpResponseStatus FOUND = newStatus(bl.eb, "Found");
    public static final HttpResponseStatus SEE_OTHER = newStatus(bl.ec, "See Other");
    public static final HttpResponseStatus NOT_MODIFIED = newStatus(bl.ed, "Not Modified");
    public static final HttpResponseStatus USE_PROXY = newStatus(bl.ee, "Use Proxy");
    ...
    public static HttpResponseStatus valueOf(int code, String reasonPhrase) {
        ...
        return (responseStatus == null || !responseStatus.reasonPhrase().contentEquals(reasonPhrase)) ? new HttpResponseStatus(code, reasonPhrase) : responseStatus;
    }
    ...
    public boolean equals(Object o) {
        return (o instanceof HttpResponseStatus) && code() == ((HttpResponseStatus) o).code();
    }
