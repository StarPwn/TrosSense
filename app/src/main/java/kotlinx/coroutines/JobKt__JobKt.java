...
public final /* synthetic */ class JobKt__JobKt {
    ...
    /* renamed from: Job */
    public static final /* synthetic */ Job m1773Job(Job parent) {
        return JobKt.Job(parent);
    }

    /* renamed from: Job$default */
    public static /* synthetic */ Job m1774Job$default(Job job, int i, Object obj) {
        Job m1773Job;
        if ((i & 1) != 0) {
            job = null;
        }
        m1773Job = m1773Job(job);
        return m1773Job;
    }
    ...
    public static final /* synthetic */ void cancelChildren(Job $this$cancelChildren, Throwable cause) {
        ...
        for (Object element$iv : $this$forEach$iv) {
            Job it2 = (Job) element$iv;
            JobSupport jobSupport = it2 instanceof JobSupport ? (JobSupport) it2 : null;
            if (jobSupport != null) {
