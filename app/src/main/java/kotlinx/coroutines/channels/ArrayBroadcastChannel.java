...
public final class ArrayBroadcastChannel<E> extends AbstractSendChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        Subscriber it2 = new Subscriber(this);
        updateHead$default(this, it2, null, 2, null);
        return it2;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:47:0x00b6, code lost:            if (kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED() == false) goto L57;     */
    /* JADX WARN: Code restructure failed: missing block: B:51:0x00be, code lost:            if (r16 != kotlinx.coroutines.CancellableContinuationImplKt.RESUME_TOKEN) goto L50;     */
    /* JADX WARN: Code restructure failed: missing block: B:53:0x00c3, code lost:            if (r18 == false) goto L99;     */
    /* JADX WARN: Code restructure failed: missing block: B:58:0x00dc, code lost:            r25.buffer[(int) (r10 % r25.capacity)] = r3.getElement();        setSize(r0 + 1);        setTail(r10 + 1);        r0 = kotlin.Unit.INSTANCE;     */
    /* JADX WARN: Code restructure failed: missing block: B:61:0x0100, code lost:            r0 = th;     */
    /* JADX WARN: Code restructure failed: missing block: B:66:0x00cb, code lost:            throw new java.lang.AssertionError();     */
    /* JADX WARN: Code restructure failed: missing block: B:68:0x00c1, code lost:            r18 = false;     */
    /* JADX WARN: Code restructure failed: missing block: B:69:0x00cc, code lost:            r0 = th;     */
    /*
    ...
    public static final class Subscriber<E> extends AbstractChannel<E> implements ReceiveChannel<E> {
        ...
        protected Object pollInternal() {
            ...
            try {
                ...
                reentrantLock.unlock();
                Closed it2 = result instanceof Closed ? (Closed) result : null;
                if (it2 != null) {
                    close(it2.closeCause);
                }
                if (checkOffer()) {
                    updated = true;
                }
        ...
        protected Object pollSelectInternal(SelectInstance<?> select) {
            ...
            try {
                ...
                Closed it2 = result2 instanceof Closed ? (Closed) result2 : null;
                if (it2 != null) {
                    close(it2.closeCause);
                }
                if (checkOffer()) {
