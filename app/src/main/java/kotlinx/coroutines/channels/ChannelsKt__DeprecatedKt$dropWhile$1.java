...
@DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$dropWhile$1", f = "Deprecated.kt", i = {0, 1, 1, 2, 3, 4}, l = {bl.cf, bl.cg, bl.ch, bl.cl, bl.cm}, m = "invokeSuspend", n = {"$this$produce", "$this$produce", RsaJsonWebKey.EXPONENT_MEMBER_NAME, "$this$produce", "$this$produce", "$this$produce"}, s = {"L$0", "L$0", "L$2", "L$0", "L$0", "L$0"})
