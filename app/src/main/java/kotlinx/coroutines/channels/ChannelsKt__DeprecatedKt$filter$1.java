...
@DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$filter$1", f = "Deprecated.kt", i = {0, 1, 1, 2}, l = {bl.cw, bl.cx, bl.cx}, m = "invokeSuspend", n = {"$this$produce", "$this$produce", RsaJsonWebKey.EXPONENT_MEMBER_NAME, "$this$produce"}, s = {"L$0", "L$0", "L$2", "L$0"})
