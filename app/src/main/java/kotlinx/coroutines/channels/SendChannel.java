...
public interface SendChannel<E> {
    ...
    Object mo1787trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo1787trySendJP2dKIU(e);
            if (ChannelResult.m1802isSuccessimpl(result)) {
                return true;
            }
            Throwable m1796exceptionOrNullimpl = ChannelResult.m1796exceptionOrNullimpl(result);
