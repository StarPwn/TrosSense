...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo1785receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo1785receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo1786tryReceivePtdJZtk() {
        return this._channel.mo1786tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo1787trySendJP2dKIU(E element) {
        return this._channel.mo1787trySendJP2dKIU(element);
    }
