...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Send takeFirstSendOrPeekClosed() {
        ...
        while (true) {
            ...
            Send it2 = (Send) first$iv;
            if (((it2 instanceof Closed) && !first$iv.isRemoved()) || (next$iv = first$iv.removeOrNext()) == null) {
                break;
            }
    ...
    public boolean offer(E element) {
        UndeliveredElementException it2;
        try {
            return SendChannel.DefaultImpls.offer(this, element);
        } catch (Throwable e) {
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            if (function1 != null && (it2 = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, element, null, 2, null)) != null) {
                ExceptionsKt.addSuppressed(it2, e);
                throw it2;
            }
            throw e;
        }
    ...
    public final Object mo1787trySendJP2dKIU(E element) {
        ...
        if (result == AbstractChannelKt.OFFER_FAILED) {
            ...
            return closedForSend == null ? ChannelResult.INSTANCE.m1806failurePtdJZtk() : ChannelResult.INSTANCE.m1805closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (result instanceof Closed) {
            return ChannelResult.INSTANCE.m1805closedJP2dKIU(helpCloseAndGetSendException((Closed) result));
        }
    ...
    private final Throwable helpCloseAndGetSendException(E element, Closed<?> closed) {
        ...
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        if (function1 != null && (it2 = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, element, null, 2, null)) != null) {
            ExceptionsKt.addSuppressed(it2, closed.getSendException());
            throw it2;
        }
        return closed.getSendException();
    }
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (offerResult == AbstractChannelKt.OFFER_SUCCESS) {
                ...
                cont.resumeWith(Result.m280constructorimpl(Unit.INSTANCE));
                break;
            }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        if (function1 != null && (it2 = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ExceptionsKt.addSuppressed(it2, sendException);
            Result.Companion companion = Result.INSTANCE;
            continuation.resumeWith(Result.m280constructorimpl(ResultKt.createFailure(it2)));
        } else {
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m280constructorimpl(ResultKt.createFailure(sendException)));
        }
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0050, code lost:            if (r4 != false) goto L23;     */
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0054, code lost:            return kotlinx.coroutines.channels.AbstractChannelKt.ENQUEUE_FAILED;     */
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0055, code lost:            return null;     */
    /*
    ...
    */
    ...
    private final void helpClose(Closed<?> closed) {
        Object closedList = InlineList.m1823constructorimpl$default(null, 1, null);
        while (true) {
            LockFreeLinkedListNode prevNode = closed.getPrevNode();
            Receive previous = prevNode instanceof Receive ? (Receive) prevNode : null;
            if (previous == null) {
                break;
            } else if (!previous.mo1831remove()) {
                previous.helpRemove();
            } else {
                closedList = InlineList.m1828plusFjFbRPM(closedList, previous);
            }
        }
        if (closedList != null) {
            if (!(closedList instanceof ArrayList)) {
                Receive it2 = (Receive) closedList;
                ...
                for (int i$iv = list$iv.size() - 1; -1 < i$iv; i$iv--) {
                    Receive it3 = (Receive) list$iv.get(i$iv);
                    it3.resumeReceiveClosed(closed);
                }
            }
        }
    ...
    public ReceiveOrClosed<E> takeFirstReceiveOrPeekClosed() {
        ...
        while (true) {
            ...
            ReceiveOrClosed it2 = (ReceiveOrClosed) r2;
            if (((it2 instanceof Closed) && !r2.isRemoved()) || (next$iv = r2.removeOrNext()) == null) {
                break;
            }
            next$iv.helpRemovePrev();
        }
