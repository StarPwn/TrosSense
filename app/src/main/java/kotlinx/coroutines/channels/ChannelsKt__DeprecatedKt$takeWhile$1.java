...
@DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$takeWhile$1", f = "Deprecated.kt", i = {0, 1, 1, 2}, l = {bl.dF, bl.dG, bl.dH}, m = "invokeSuspend", n = {"$this$produce", "$this$produce", RsaJsonWebKey.EXPONENT_MEMBER_NAME, "$this$produce"}, s = {"L$0", "L$0", "L$2", "L$0"})
