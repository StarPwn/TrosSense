...
@DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$filterIndexed$1", f = "Deprecated.kt", i = {0, 0, 1, 1, 1, 2, 2}, l = {bl.cJ, bl.cK, bl.cK}, m = "invokeSuspend", n = {"$this$produce", "index", "$this$produce", RsaJsonWebKey.EXPONENT_MEMBER_NAME, "index", "$this$produce", "index"}, s = {"L$0", "I$0", "L$0", "L$2", "I$0", "L$0", "I$0"})
