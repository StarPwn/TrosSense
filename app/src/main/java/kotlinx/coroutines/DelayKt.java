...
public final class DelayKt {
    ...
    */
    ...
    public static final Object m1769delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object delay = delay(m1770toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m1770toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m1605compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.INSTANCE.m1708getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1624getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1L);
        }
        return 0L;
    }
}
