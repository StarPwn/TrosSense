...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m280constructorimpl = Result.m280constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m280constructorimpl = Result.m280constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m286isFailureimpl(m280constructorimpl) ? null : m280constructorimpl);
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1832dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void updateChoreographerAndPostFrameCallback(CancellableContinuation<? super Long> cancellableContinuation) {
        Choreographer it2 = choreographer;
        if (it2 == null) {
            it2 = Choreographer.getInstance();
            Intrinsics.checkNotNull(it2);
            choreographer = it2;
        }
        postFrameCallback(it2, cancellableContinuation);
    }
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1783postFrameCallback$lambda6(CancellableContinuation.this, j);
            }
        });
    }
    ...
    public static final void m1783postFrameCallback$lambda6(CancellableContinuation $cont, long nanos) {
