    ...
    public final class Worker extends Thread {
        ...
        private final Task findAnyTask(boolean scanLocalQueue) {
            ...
            if (scanLocalQueue) {
                ...
                if (globalFirst && (it3 = pollGlobalQueues()) != null) {
                    return it3;
                }
                Task it4 = this.localQueue.poll();
                if (it4 != null) {
                    return it4;
                }
        ...
        private final Task pollGlobalQueues() {
            if (nextInt(2) == 0) {
                Task it2 = CoroutineScheduler.this.globalCpuQueue.removeFirstOrNull();
                if (it2 != null) {
                    return it2;
                }
                return CoroutineScheduler.this.globalBlockingQueue.removeFirstOrNull();
            }
            Task it3 = CoroutineScheduler.this.globalBlockingQueue.removeFirstOrNull();
            if (it3 != null) {
                return it3;
            }
