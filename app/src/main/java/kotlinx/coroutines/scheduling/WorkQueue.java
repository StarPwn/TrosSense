...
public final class WorkQueue {
    ...
    public final long tryStealBlockingFrom(WorkQueue victim) {
        ...
        for (int start = victim.consumerIndex; start != end; start++) {
            ...
            if (value != null) {
                ...
                if ($this$isBlocking$iv != null && Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(buffer, index, value, null)) {
    ...
    public final void offloadAllWorkTo(GlobalQueue globalQueue) {
        Task it2 = (Task) lastScheduledTask$FU.getAndSet(this, null);
        if (it2 != null) {
            globalQueue.addLast(it2);
        }
        do {
