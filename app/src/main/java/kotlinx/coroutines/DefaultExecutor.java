    ...
    public final synchronized void shutdownForTests(long timeout) {
        ...
        while (debugStatus != 3 && _thread != null) {
            ...
            if (it2 != null) {
                AbstractTimeSource timeSource = AbstractTimeSourceKt.getTimeSource();
                if (timeSource != null) {
                    timeSource.unpark(it2);
                    unit = Unit.INSTANCE;
                } else {
                    unit = null;
                }
                if (unit == null) {
                    LockSupport.unpark(it2);
                }
            }
