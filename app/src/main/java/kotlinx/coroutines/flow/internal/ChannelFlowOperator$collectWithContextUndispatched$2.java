...
@DebugMetadata(c = "kotlinx.coroutines.flow.internal.ChannelFlowOperator$collectWithContextUndispatched$2", f = "ChannelFlow.kt", i = {}, l = {bl.bN}, m = "invokeSuspend", n = {}, s = {})
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                FlowCollector<? super T> it2 = (FlowCollector) this.L$0;
                this.label = 1;
                if (this.this$0.flowCollect(it2, this) != coroutine_suspended) {
                    break;
                } else {
