...
public final class LintKt {
    ...
    private static final <T> Flow<T> m1818catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt.m1810catch(sharedFlow, function3);
    }
