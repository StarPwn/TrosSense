...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo1833scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo1833scheduleResumeAfterDelay(timeMillis, continuation);
    }
        ...
        while (true) {
            ...
            if (task != null) {
                ...
                if (fairnessCounter >= 16 && this.dispatcher.isDispatchNeeded(this)) {
                    this.dispatcher.mo1832dispatch(this, this);
                    return;
                }
            } else {
