...
public final class FastServiceLoader {
    ...
    public final <S> List<S> loadProviders$kotlinx_coroutines_core(Class<S> service, ClassLoader loader) {
        ...
        for (Object element$iv$iv : $this$flatMap$iv) {
            URL it2 = (URL) element$iv$iv;
            Iterable list$iv$iv = INSTANCE.parse(it2);
        ...
        for (Object item$iv$iv : $this$map$iv) {
            ...
            destination$iv$iv2.add(INSTANCE.getProviderInstance(it3, loader, service));
        }
    ...
    private final List<String> parse(URL url) {
        ...
        if (StringsKt.startsWith$default(path, "jar", false, 2, (Object) null)) {
            ...
            try {
                bufferedReader = new BufferedReader(new InputStreamReader($this$use$iv.getInputStream(new ZipEntry(entry)), StringUtil.UTF_8));
                try {
    ...
    private final List<String> parseFile(BufferedReader r) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                char it2 = (element$iv == '.' || Character.isJavaIdentifierPart(element$iv)) ? (char) 1 : (char) 0;
                if (it2 == 0) {
                    $this$all$iv = null;
                    break;
                }
