    ...
    public final void run() {
        ...
        try {
            ...
            try {
                ...
                result = Result.m280constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                th = th;
                Result.Companion companion2 = Result.INSTANCE;
                result = Result.m280constructorimpl(ResultKt.createFailure(th));
                handleFatalException(fatalException, Result.m283exceptionOrNullimpl(result));
            }
        }
        try {
            ...
            try {
                if (job != null && !job.isActive()) {
                    ...
                    if (DebugKt.getRECOVER_STACK_TRACES()) {
                        try {
                            if (continuation instanceof CoroutineStackFrame) {
                                ...
                                continuation.resumeWith(Result.m280constructorimpl(ResultKt.createFailure(cancellationException)));
                            }
                        } catch (Throwable th3) {
                            th = th3;
                    ...
                    continuation.resumeWith(Result.m280constructorimpl(ResultKt.createFailure(exception)));
                } else {
                    Result.Companion companion5 = Result.INSTANCE;
                    continuation.resumeWith(Result.m280constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                }
