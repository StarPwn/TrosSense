...
public final class Path implements Comparable<Path> {
    ...
    public final List<String> getSegments() {
        ...
        int segmentStart$iv$iv = _PathKt.access$rootLength(this);
    ...
    public final List<ByteString> getSegmentsBytes() {
        ...
        int segmentStart$iv = _PathKt.access$rootLength(this);
    ...
    public final Path parent() {
        ...
        if (lastSlash$iv == 1 && getBytes().startsWith(_PathKt.access$getBACKSLASH$p())) {
            return null;
        }
    ...
    public final Path relativeTo(Path other) {
        ...
        ByteString slash$iv = _PathKt.access$getSlash(other);
        if (slash$iv == null && (slash$iv = _PathKt.access$getSlash(this)) == null) {
            slash$iv = _PathKt.access$toSlash(DIRECTORY_SEPARATOR);
        }
