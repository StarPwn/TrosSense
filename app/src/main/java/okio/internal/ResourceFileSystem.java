        ...
        while (true) {
            ...
            if (listOrNull != null) {
                ...
                for (Object item$iv$iv : $this$map$iv) {
                    Path it4 = (Path) item$iv$iv;
                    destination$iv$iv2.add(Companion.removeBase(it4, base));
                }
    ...
    public static final class Companion {
        ...
        public final List<Pair<FileSystem, Path>> toClasspathRoots(ClassLoader $this$toClasspathRoots) {
            ...
            for (Object element$iv$iv$iv : $this$mapNotNull$iv) {
                URL it2 = (URL) element$iv$iv$iv;
                Iterable $this$mapNotNull$iv2 = $this$mapNotNull$iv;
                Companion companion = ResourceFileSystem.Companion;
                Intrinsics.checkNotNullExpressionValue(it2, "it");
                Pair<FileSystem, Path> fileRoot = companion.toFileRoot(it2);
                if (fileRoot != null) {
            ...
            for (Object element$iv$iv$iv2 : (List) list2) {
                URL it3 = (URL) element$iv$iv$iv2;
                Companion companion2 = ResourceFileSystem.Companion;
                Intrinsics.checkNotNullExpressionValue(it3, "it");
                Pair<FileSystem, Path> jarRoot = companion2.toJarRoot(it3);
                if (jarRoot != null) {
        ...
        public final Pair<FileSystem, Path> toJarRoot(URL $this$toJarRoot) {
            ...
            String substring = urlString.substring("jar:".length(), suffixStart);
