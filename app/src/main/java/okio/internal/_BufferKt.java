...
public final class _BufferKt {
        ...
        loop0: while (true) {
            ...
            if (scanOrSelect2 < 0) {
                ...
                while (true) {
                    ...
                    if (($this$and$iv & 255) != trie[triePos2]) {
                        return prefixIndex;
                    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:43:0x00c2, code lost:            r1.setSize$okio(r18.size() - r6);     */
    /* JADX WARN: Code restructure failed: missing block: B:44:0x00cb, code lost:            if (r7 == false) goto L115;     */
    /* JADX WARN: Code restructure failed: missing block: B:45:0x00cd, code lost:            r0 = 2;     */
    /* JADX WARN: Code restructure failed: missing block: B:46:0x00d0, code lost:            if (r6 >= r0) goto L126;     */
    /* JADX WARN: Code restructure failed: missing block: B:48:0x00da, code lost:            if (r18.size() == 0) goto L124;     */
    /* JADX WARN: Code restructure failed: missing block: B:49:0x00dc, code lost:            if (r7 == false) goto L121;     */
    /* JADX WARN: Code restructure failed: missing block: B:50:0x00de, code lost:            r4 = "Expected a digit";     */
    /* JADX WARN: Code restructure failed: missing block: B:52:0x0109, code lost:            throw new java.lang.NumberFormatException(r4 + " but was 0x" + okio._UtilKt.toHexString(r1.getByte(0)));     */
    /* JADX WARN: Code restructure failed: missing block: B:53:0x00e1, code lost:            r4 = "Expected a digit or '-'";     */
    /* JADX WARN: Code restructure failed: missing block: B:55:0x010f, code lost:            throw new java.io.EOFException();     */
    /* JADX WARN: Code restructure failed: missing block: B:56:0x0110, code lost:            if (r7 == false) goto L128;     */
    /* JADX WARN: Code restructure failed: missing block: B:58:?, code lost:            return r2;     */
    /* JADX WARN: Code restructure failed: missing block: B:60:0x0115, code lost:            return -r2;     */
    /* JADX WARN: Code restructure failed: missing block: B:61:0x00cf, code lost:            r0 = 1;     */
    /*
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:40:0x00be A[EDGE_INSN: B:40:0x00be->B:37:0x00be BREAK  A[LOOP:0: B:4:0x0014->B:39:?], SYNTHETIC] */
    ...
    */
    ...
    public static final Buffer commonWriteUtf8(Buffer $this$commonWriteUtf8, String string, int beginIndex, int endIndex) {
        ...
        while (i2 < endIndex) {
            ...
            if (c < 128) {
                ...
                tail2.data[tail2.limit] = (byte) ((c >> 6) | bl.cq);
                ...
                tail3.data[tail3.limit] = (byte) ((c >> 12) | bl.cW);
                ...
                if (c <= 56319) {
                    if (56320 <= low && low < 57344) {
                        ...
                        tail4.data[tail4.limit] = (byte) ((codePoint >> 18) | bl.db);
    ...
    public static final Buffer commonWriteUtf8CodePoint(Buffer $this$commonWriteUtf8CodePoint, int codePoint) {
        ...
        if (codePoint < 128) {
            ...
            tail.data[tail.limit] = (byte) ((codePoint >> 6) | bl.cq);
            ...
            if (z) {
                ...
                tail2.data[tail2.limit] = (byte) ((codePoint >> 12) | bl.cW);
                ...
                tail3.data[tail3.limit] = (byte) ((codePoint >> 18) | bl.db);
    ...
    public static final long commonWriteAll(Buffer $this$commonWriteAll, Source source) {
        ...
        while (true) {
            long readCount = source.read($this$commonWriteAll, Http2CodecUtil.DEFAULT_HEADER_LIST_SIZE);
            if (readCount != -1) {
        ...
        while (byteCount2 > 0) {
            ...
            if (byteCount2 < i - r2.pos) {
                ...
                if (tail != null && tail.owner) {
                    if ((tail.limit + byteCount2) - (tail.shared ? 0 : tail.pos) <= Http2CodecUtil.DEFAULT_HEADER_LIST_SIZE) {
