...
public abstract class FileSystem {
    ...
    public final <T> T m1995read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
        ...
        try {
            BufferedSource it2 = (BufferedSource) $this$use$iv;
            t = readerAction.invoke(it2);
    ...
    public static /* synthetic */ Object m1994write$default(FileSystem fileSystem, Path file, boolean mustCreate, Function1 writerAction, int i, Object obj) throws IOException {
        if (obj == null) {
            if ((i & 2) != 0) {
                mustCreate = false;
            }
            ...
            Throwable thrown$iv = null;
            try {
                BufferedSink it2 = (BufferedSink) $this$use$iv;
                result$iv = writerAction.invoke(it2);
            } catch (Throwable t$iv) {
                thrown$iv = t$iv;
            }
            if ($this$use$iv != null) {
    ...
    public final <T> T m1996write(Path file, boolean mustCreate, Function1<? super BufferedSink, ? extends T> writerAction) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
