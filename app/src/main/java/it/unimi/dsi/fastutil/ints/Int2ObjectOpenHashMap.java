...
public class Int2ObjectOpenHashMap<V> extends AbstractInt2ObjectMap<V> implements Serializable, Cloneable, Hash {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ObjectOpenHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.c++;
                acceptOnIndex(action, Int2ObjectOpenHashMap.this.n);
                return true;
            }
            int[] key = Int2ObjectOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (this.hasSplit) {
                return Math.min(Int2ObjectOpenHashMap.this.size - this.c, ((long) ((Int2ObjectOpenHashMap.this.realSize() / Int2ObjectOpenHashMap.this.n) * (this.max - this.pos))) + (this.mustReturnNull ? 1L : 0L));
            }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements Int2ObjectMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Int2ObjectMap.Entry<V>> consumer) {
            ...
            while (true) {
                int pos2 = pos - 1;
                if (pos != 0) {
                    if (Int2ObjectOpenHashMap.this.key[pos2] != 0) {
        ...
        public void fastForEach(Consumer<? super Int2ObjectMap.Entry<V>> consumer) {
            Int2ObjectOpenHashMap<V>.MapEntry entry = new MapEntry();
            if (Int2ObjectOpenHashMap.this.containsNullKey) {
    ...
    public final class KeySet extends AbstractIntSet {
        ...
        public void forEach(java.util.function.IntConsumer consumer) {
            ...
            int k = Int2ObjectOpenHashMap.this.n;
            while (true) {
                int pos = k - 1;
                if (k != 0) {
    ...
    public final class ValueIterator extends Int2ObjectOpenHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
        ...
        public final void acceptOnIndex(Consumer<? super V> consumer, int i) {
            consumer.accept(Int2ObjectOpenHashMap.this.value[i]);
        }
    ...
    public ObjectCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>() { // from class: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap.1
    ...
    public Int2ObjectOpenHashMap<V> m223clone() {
        try {
