...
public class Long2ObjectOpenHashMap<V> extends AbstractLong2ObjectMap<V> implements Serializable, Cloneable, Hash {
    ...
    public abstract class MapIterator<ConsumerType> {
        ...
        public void remove() {
            ...
            Long2ObjectOpenHashMap long2ObjectOpenHashMap = Long2ObjectOpenHashMap.this;
    ...
    public final class EntryIterator extends Long2ObjectOpenHashMap<V>.MapIterator<Consumer<? super Long2ObjectMap.Entry<V>>> implements ObjectIterator<Long2ObjectMap.Entry<V>> {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // it.unimi.dsi.fastutil.longs.Long2ObjectOpenHashMap.MapIterator
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends Long2ObjectOpenHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.c++;
                acceptOnIndex(action, Long2ObjectOpenHashMap.this.n);
                return true;
            }
            long[] key = Long2ObjectOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (this.hasSplit) {
                return Math.min(Long2ObjectOpenHashMap.this.size - this.c, ((long) ((Long2ObjectOpenHashMap.this.realSize() / Long2ObjectOpenHashMap.this.n) * (this.max - this.pos))) + (this.mustReturnNull ? 1L : 0L));
            }
    ...
    public final class EntrySpliterator extends Long2ObjectOpenHashMap<V>.MapSpliterator<Consumer<? super Long2ObjectMap.Entry<V>>, Long2ObjectOpenHashMap<V>.EntrySpliterator> implements ObjectSpliterator<Long2ObjectMap.Entry<V>> {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // it.unimi.dsi.fastutil.longs.Long2ObjectOpenHashMap.MapSpliterator
        public final void acceptOnIndex(Consumer<? super Long2ObjectMap.Entry<V>> action, int index) {
    ...
    public final class MapEntrySet extends AbstractObjectSet<Long2ObjectMap.Entry<V>> implements Long2ObjectMap.FastEntrySet<V> {
        ...
        public boolean remove(Object o) {
            ...
            if (curr == k) {
                if (!Objects.equals(Long2ObjectOpenHashMap.this.value[pos], value)) {
                    return false;
                }
        ...
        public void forEach(Consumer<? super Long2ObjectMap.Entry<V>> consumer) {
            ...
            while (true) {
                int pos2 = pos - 1;
                if (pos != 0) {
                    if (Long2ObjectOpenHashMap.this.key[pos2] != 0) {
        ...
        public void fastForEach(Consumer<? super Long2ObjectMap.Entry<V>> consumer) {
            Long2ObjectOpenHashMap<V>.MapEntry entry = new MapEntry();
            if (Long2ObjectOpenHashMap.this.containsNullKey) {
    ...
    public final class KeySet extends AbstractLongSet {
        ...
        public void forEach(java.util.function.LongConsumer consumer) {
            ...
            while (true) {
                int pos2 = pos - 1;
                if (pos != 0) {
                    long k = Long2ObjectOpenHashMap.this.key[pos2];
                    if (k != 0) {
                        consumer.accept(k);
                    }
                    pos = pos2;
            ...
            this.values = new AbstractObjectCollection<V>() { // from class: it.unimi.dsi.fastutil.longs.Long2ObjectOpenHashMap.1
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (true) {
                        int i2 = i - 1;
                        if (i != 0) {
                            if (Long2ObjectOpenHashMap.this.key[i2] != 0) {
                                consumer.accept(Long2ObjectOpenHashMap.this.value[i2]);
                            }
                            i = i2;
                        } else {
                            return;
    ...
    public Long2ObjectOpenHashMap<V> m242clone() {
        try {
