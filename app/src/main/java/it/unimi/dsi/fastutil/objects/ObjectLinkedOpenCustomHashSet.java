...
public class ObjectLinkedOpenCustomHashSet<K> extends AbstractObjectSortedSet<K> implements Serializable, Cloneable, Hash {
    ...
    public final class SetIterator implements ObjectListIterator<K> {
        ...
        SetIterator(K k) {
            ...
            while (kArr[mix] != null) {
                if (ObjectLinkedOpenCustomHashSet.this.strategy.equals(kArr[mix], k)) {
                    this.next = (int) ObjectLinkedOpenCustomHashSet.this.link[mix];
                    this.prev = mix;
                    return;
                }
                mix = (mix + 1) & ObjectLinkedOpenCustomHashSet.this.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this set.");
        }
        ...
        public void remove() {
            ...
            ObjectLinkedOpenCustomHashSet objectLinkedOpenCustomHashSet = ObjectLinkedOpenCustomHashSet.this;
            objectLinkedOpenCustomHashSet.size--;
            if (this.prev == -1) {
            ...
            if (this.next == -1) {
                ...
                int i2 = this.next;
                jArr2[i2] = ((((4294967295L & this.prev) << 32) ^ ObjectLinkedOpenCustomHashSet.this.link[this.next]) & (-4294967296L)) ^ jArr2[i2];
            }
            int pos = this.curr;
            this.curr = -1;
    ...
    protected void rehash(int i) {
        ...
        while (true) {
            ...
            if (this.strategy.equals(kArr2[i4], null)) {
                mix = i;
            } else {
                mix = HashCommon.mix(this.strategy.hashCode(kArr2[i4])) & i3;
    ...
    public ObjectLinkedOpenCustomHashSet<K> m271clone() {
        try {
