...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public final void connect(OkHttpClient client) {
        ...
        final Request request = this.originalRequest.newBuilder().header("Upgrade", "websocket").header("Connection", "Upgrade").header(HttpHeaders.Names.SEC_WEBSOCKET_KEY, this.key).header(HttpHeaders.Names.SEC_WEBSOCKET_VERSION, "13").header("Sec-WebSocket-Extensions", "permessage-deflate").build();
    ...
    public final void checkUpgradeSuccess$okhttp(Response response, Exchange exchange) throws IOException {
        ...
        String headerAccept = Response.header$default(response, HttpHeaders.Names.SEC_WEBSOCKET_ACCEPT, null, 2, null);
        String acceptExpected = ByteString.INSTANCE.encodeUtf8(Intrinsics.stringPlus(this.key, "258EAFA5-E914-47DA-95CA-C5AB0DC85B11")).sha1().base64();
