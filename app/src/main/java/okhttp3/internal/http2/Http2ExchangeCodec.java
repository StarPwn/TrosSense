    ...
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(Request request) {
            ...
            while (i < size) {
                ...
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(name2) || (Intrinsics.areEqual(name2, Http2ExchangeCodec.TE) && Intrinsics.areEqual(headers.value(i2), HttpHeaders.Values.TRAILERS))) {
