    ...
    public static final class Companion {
        ...
        public final List<String> alpnProtocolNames(List<? extends Protocol> protocols) {
            ...
            for (Object element$iv$iv : $this$filter$iv) {
                Protocol it2 = (Protocol) element$iv$iv;
                if (it2 != Protocol.HTTP_1_0) {
            ...
            for (Object item$iv$iv : $this$map$iv) {
                Protocol it3 = (Protocol) item$iv$iv;
                destination$iv$iv2.add(it3.getProtocol());
            }
