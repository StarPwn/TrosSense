...
public final class RealCall implements Call {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:11:0x001f, code lost:            if (r6.responseBodyOpen != false) goto L17;     */
    /*
    ...
    */
    ...
    public final Socket releaseConnectionNoEvents$okhttp() {
        ...
        if (!Util.assertionsEnabled || Thread.holdsLock(connection)) {
            ...
            while (true) {
                if (it2.hasNext()) {
                    Reference item$iv = it2.next();
                    Reference it3 = item$iv;
                    if (Intrinsics.areEqual(it3.get(), this)) {
                        break;
                    }
                    index$iv++;
                } else {
