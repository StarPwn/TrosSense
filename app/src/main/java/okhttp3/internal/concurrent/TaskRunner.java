...
public final class TaskRunner {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (loggingEnabled$iv) {
                                TaskLoggerKt.access$log(task, queue$iv, Intrinsics.stringPlus("finished run in ", TaskLoggerKt.formatDuration(queue$iv.getTaskRunner().getBackend().nanoTime() - startNs$iv)));
                            }
                        } catch (Throwable th) {
                            if (loggingEnabled$iv) {
                                long elapsedNs$iv = queue$iv.getTaskRunner().getBackend().nanoTime() - startNs$iv;
                                if (0 != 0) {
                                    TaskLoggerKt.access$log(task, queue$iv, Intrinsics.stringPlus("finished run in ", TaskLoggerKt.formatDuration(elapsedNs$iv)));
                                } else {
                                    TaskLoggerKt.access$log(task, queue$iv, Intrinsics.stringPlus("failed a run in ", TaskLoggerKt.formatDuration(elapsedNs$iv)));
                                }
                            }
                            throw th;
                        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x003a, code lost:            if (r2.getFutureTasks$okhttp().isEmpty() == false) goto L17;     */
    /* JADX WARN: Code restructure failed: missing block: B:11:0x003c, code lost:            r4.readyQueues.remove(r1);     */
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0041, code lost:            if (r0 >= 0) goto L18;     */
    /* JADX WARN: Code restructure failed: missing block: B:15:?, code lost:            return;     */
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0043, code lost:            return;     */
    /* JADX WARN: Code restructure failed: missing block: B:2:0x0008, code lost:            if (r0 >= 0) goto L4;     */
    /* JADX WARN: Code restructure failed: missing block: B:3:0x000a, code lost:            r1 = r0;        r0 = r0 - 1;        r4.busyQueues.get(r1).cancelAllAndDecide$okhttp();     */
    /* JADX WARN: Code restructure failed: missing block: B:4:0x0018, code lost:            if (r0 >= 0) goto L14;     */
    /* JADX WARN: Code restructure failed: missing block: B:7:0x001a, code lost:            r0 = r4.readyQueues.size() - 1;     */
    /* JADX WARN: Code restructure failed: missing block: B:8:0x0022, code lost:            if (r0 < 0) goto L12;     */
    /* JADX WARN: Code restructure failed: missing block: B:9:0x0024, code lost:            r1 = r0;        r0 = r0 - 1;        r2 = r4.readyQueues.get(r1);        r2.cancelAllAndDecide$okhttp();     */
    /*
