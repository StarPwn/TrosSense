...
public final class HttpHeaders {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0081, code lost:            r11.add(new okhttp3.Challenge(r1, (java.util.Map<java.lang.String, java.lang.String>) r6));     */
    /*
    ...
    */
    ...
    public static final boolean promisesBody(Response $this$promisesBody) {
        ...
        return (((responseCode >= 100 && responseCode < 200) || responseCode == 204 || responseCode == 304) && Util.headersContentLength($this$promisesBody) == -1 && !StringsKt.equals(HttpHeaders.Values.CHUNKED, Response.header$default($this$promisesBody, "Transfer-Encoding", null, 2, null), true)) ? false : true;
    }
