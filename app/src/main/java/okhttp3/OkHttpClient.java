...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public OkHttpClient(Builder builder) {
        ...
        if (!($this$none$iv instanceof Collection) || !((Collection) $this$none$iv).isEmpty()) {
            ...
            while (true) {
                ...
                ConnectionSpec it3 = (ConnectionSpec) element$iv;
                if (it3.getIsTls()) {
                    z = false;
                    break;
                }
    ...
    public static final class Builder {
        ...
        public final Builder callTimeout(long timeout, TimeUnit unit) {
            ...
            $this$callTimeout_u24lambda_u2d28.setCallTimeout$okhttp(Util.checkDuration(RtspHeaders.Values.TIMEOUT, timeout, unit));
            return this;
        }
        ...
        public final Builder connectTimeout(long timeout, TimeUnit unit) {
            ...
            $this$connectTimeout_u24lambda_u2d30.setConnectTimeout$okhttp(Util.checkDuration(RtspHeaders.Values.TIMEOUT, timeout, unit));
            return this;
        }
        ...
        public final Builder readTimeout(long timeout, TimeUnit unit) {
            ...
            $this$readTimeout_u24lambda_u2d32.setReadTimeout$okhttp(Util.checkDuration(RtspHeaders.Values.TIMEOUT, timeout, unit));
            return this;
        }
        ...
        public final Builder writeTimeout(long timeout, TimeUnit unit) {
            ...
            $this$writeTimeout_u24lambda_u2d34.setWriteTimeout$okhttp(Util.checkDuration(RtspHeaders.Values.TIMEOUT, timeout, unit));
            return this;
        }
