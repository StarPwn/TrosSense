...
public final class Dispatcher {
    ...
    private final RealCall.AsyncCall findExistingCallWithHost(String host) {
        ...
        while (it2.hasNext()) {
            RealCall.AsyncCall existingCall = it2.next();
        ...
        while (it3.hasNext()) {
            RealCall.AsyncCall existingCall2 = it3.next();
    ...
    public final synchronized List<Call> queuedCalls() {
        ...
        for (Object item$iv$iv : $this$map$iv) {
            RealCall.AsyncCall it2 = (RealCall.AsyncCall) item$iv$iv;
            destination$iv$iv.add(it2.getThis$0());
        }
