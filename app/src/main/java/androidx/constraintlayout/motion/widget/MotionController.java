...
public class MotionController {
    ...
    public void buildPath(float[] points, int pointCount) {
        ...
        while (i2 < i) {
            ...
            float start = 0.0f;
            float end = Float.NaN;
            Iterator<MotionPaths> it2 = motionController.mMotionPaths.iterator();
            while (it2.hasNext()) {
                MotionPaths frame = it2.next();
                float mils2 = mils;
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (!splineAttributes.isEmpty()) {
            ...
            Iterator<String> it5 = splineAttributes.iterator();
            while (it5.hasNext()) {
                String attribute = it5.next();
        ...
        if (this.mKeyList != null) {
            Iterator<String> it12 = cycleAttributes.iterator();
            while (it12.hasNext()) {
                String attribute3 = it12.next();
