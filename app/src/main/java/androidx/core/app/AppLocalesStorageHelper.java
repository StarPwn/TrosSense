...
public class AppLocalesStorageHelper {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:36:0x0043, code lost:            r1 = r3.getAttributeValue(null, androidx.core.app.AppLocalesStorageHelper.LOCALE_RECORD_ATTRIBUTE_TAG);     */
                ...
                try {
                    try {
                        try {
                            ...
                            serializer.startDocument(StringUtil.UTF_8, true);
