...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        if (!canScroll) {
            ...
            View nextFocused = FocusFinder.getInstance().findNextFocus(this, currentFocused, bl.br);
            return (nextFocused == null || nextFocused == this || !nextFocused.requestFocus(bl.br)) ? false : true;
        }
        ...
        switch (event.getKeyCode()) {
            ...
            case 20:
                if (event.isAltPressed()) {
                    boolean handled3 = fullScroll(bl.br);
                    return handled3;
                }
                boolean handled4 = arrowScroll(bl.br);
                return handled4;
            case 62:
            ...
            case 92:
                ...
                return handled5;
            case 93:
                boolean handled6 = fullScroll(bl.br);
                return handled6;
            case 122:
                pageScroll(33);
                return false;
