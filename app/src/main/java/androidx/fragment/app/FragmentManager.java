...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public /* synthetic */ void m46lambda$new$0$androidxfragmentappFragmentManager(Configuration newConfig) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m47lambda$new$1$androidxfragmentappFragmentManager(Integer level) {
    ...
    public /* synthetic */ void m48lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo info) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m49lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo info) {
        if (isParentAdded()) {
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) {
        ...
        if (!allowReordering && this.mCurState >= 1) {
            for (int index = startIndex; index < endIndex; index++) {
                Iterator<FragmentTransaction.Op> it2 = records.get(index).mOps.iterator();
                while (it2.hasNext()) {
        ...
        for (int index2 = startIndex; index2 < endIndex; index2++) {
            ...
            if (isPop) {
                ...
                Iterator<FragmentTransaction.Op> it3 = record2.mOps.iterator();
                while (it3.hasNext()) {
                    FragmentTransaction.Op op3 = it3.next();
    ...
    boolean restoreBackStackState(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, String name) {
        ...
        while (it2.hasNext()) {
            BackStackRecord record = it2.next();
            if (record.mBeingSaved) {
                Iterator<FragmentTransaction.Op> it3 = record.mOps.iterator();
                while (it3.hasNext()) {
                    FragmentTransaction.Op op = it3.next();
        ...
        boolean added = false;
        Iterator<BackStackRecord> it4 = backStackRecords.iterator();
        while (it4.hasNext()) {
            added = it4.next().generateOps(records, isRecordPop) || added;
        }
        return added;
    }
    ...
    boolean saveBackStackState(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, String name) {
        ...
        Iterator<Fragment> it3 = allFragments.iterator();
        while (it3.hasNext()) {
            fragments.add(it3.next().mWho);
        }
    ...
    public Parcelable saveAllState() {
        ...
        Bundle savedState = m45lambda$attachController$4$androidxfragmentappFragmentManager();
    ...
    public Bundle m45lambda$attachController$4$androidxfragmentappFragmentManager() {
        ...
        if (savedState.isEmpty()) {
            ...
            Iterator<FragmentState> it2 = savedState.iterator();
            while (it2.hasNext()) {
                FragmentState state = it2.next();
    ...
    public void restoreSaveStateInternal(Parcelable state) {
        ...
        Iterator<String> it2 = fms.mActive.iterator();
        while (it2.hasNext()) {
            String who = it2.next();
    ...
    public void dispatchOnAttachFragment(Fragment fragment) {
        ...
        while (it2.hasNext()) {
            FragmentOnAttachListener listener = it2.next();
