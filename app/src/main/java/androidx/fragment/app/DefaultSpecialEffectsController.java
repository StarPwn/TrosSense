...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    void executeOperations(List<SpecialEffectsController.Operation> operations, boolean isPop) {
        ...
        Iterator<SpecialEffectsController.Operation> it2 = operations.iterator();
        while (it2.hasNext()) {
            final SpecialEffectsController.Operation operation2 = it2.next();
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:201:0x05a3, code lost:            if (r13 == r42) goto L170;     */
