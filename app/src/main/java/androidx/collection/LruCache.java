...
public class LruCache<K, V> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:11:0x0073, code lost:            throw new java.lang.IllegalStateException(getClass().getName() + ".sizeOf() is reporting inconsistent results!");     */
    /*
