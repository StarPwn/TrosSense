...
public class AnimatedStateListDrawableCompat extends StateListDrawableCompat implements TintAwareDrawable {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0047, code lost:            if (r12 != 2) goto L17;     */
    /* JADX WARN: Code restructure failed: missing block: B:12:0x0053, code lost:            if (r18.getName().equals("animated-vector") == false) goto L16;     */
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0055, code lost:            r7 = androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat.createFromXmlInner(r16, r17, r18, r19, r20);     */
    /* JADX WARN: Code restructure failed: missing block: B:14:0x005a, code lost:            r7 = androidx.appcompat.resources.Compatibility.Api21Impl.createFromXmlInner(r17, r18, r19, r20);     */
    /* JADX WARN: Code restructure failed: missing block: B:16:0x007a, code lost:            throw new org.xmlpull.v1.XmlPullParserException(r18.getPositionDescription() + androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat.TRANSITION_MISSING_DRAWABLE_ERROR);     */
    /* JADX WARN: Code restructure failed: missing block: B:19:0x007b, code lost:            if (r7 == null) goto L26;     */
    /* JADX WARN: Code restructure failed: missing block: B:20:0x007d, code lost:            if (r4 == (-1)) goto L24;     */
    /* JADX WARN: Code restructure failed: missing block: B:21:0x007f, code lost:            if (r6 == (-1)) goto L24;     */
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0088, code lost:            return r15.mState.addTransition(r4, r6, r7, r9);     */
    /* JADX WARN: Code restructure failed: missing block: B:25:0x00a6, code lost:            throw new org.xmlpull.v1.XmlPullParserException(r18.getPositionDescription() + androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat.TRANSITION_MISSING_FROM_TO_ID);     */
    /* JADX WARN: Code restructure failed: missing block: B:27:0x00c2, code lost:            throw new org.xmlpull.v1.XmlPullParserException(r18.getPositionDescription() + androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat.TRANSITION_MISSING_DRAWABLE_ERROR);     */
    /* JADX WARN: Code restructure failed: missing block: B:5:0x003b, code lost:            if (r7 == null) goto L8;     */
    /* JADX WARN: Code restructure failed: missing block: B:6:0x003d, code lost:            r12 = r18.next();     */
    /* JADX WARN: Code restructure failed: missing block: B:7:0x0043, code lost:            if (r12 != 4) goto L28;     */
    /*
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0034, code lost:            if (r6 != 2) goto L16;     */
    /* JADX WARN: Code restructure failed: missing block: B:12:0x0041, code lost:            if (r13.getName().equals("vector") == false) goto L15;     */
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0043, code lost:            r2 = androidx.vectordrawable.graphics.drawable.VectorDrawableCompat.createFromXmlInner(r12, r13, r14, r15);     */
    /* JADX WARN: Code restructure failed: missing block: B:14:0x0048, code lost:            r2 = androidx.appcompat.resources.Compatibility.Api21Impl.createFromXmlInner(r12, r13, r14, r15);     */
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0068, code lost:            throw new org.xmlpull.v1.XmlPullParserException(r13.getPositionDescription() + androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat.ITEM_MISSING_DRAWABLE_ERROR);     */
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0069, code lost:            if (r2 == null) goto L21;     */
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0071, code lost:            return r10.mState.addStateSet(r4, r2, r1);     */
    /* JADX WARN: Code restructure failed: missing block: B:23:0x008c, code lost:            throw new org.xmlpull.v1.XmlPullParserException(r13.getPositionDescription() + androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat.ITEM_MISSING_DRAWABLE_ERROR);     */
    /* JADX WARN: Code restructure failed: missing block: B:5:0x0028, code lost:            if (r2 == null) goto L7;     */
    /* JADX WARN: Code restructure failed: missing block: B:6:0x002a, code lost:            r6 = r13.next();     */
    /* JADX WARN: Code restructure failed: missing block: B:7:0x0030, code lost:            if (r6 != 4) goto L23;     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
