...
public class MenuBuilder implements SupportMenu {
    ...
    public void removeMenuPresenter(MenuPresenter presenter) {
        ...
        while (it2.hasNext()) {
            WeakReference<MenuPresenter> ref = it2.next();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:5:0x0019, code lost:            if (androidx.core.view.ViewConfigurationCompat.shouldShowMenuShortcutsWhenKeyboardPresent(android.view.ViewConfiguration.get(r3.mContext), r3.mContext) != false) goto L9;     */
    /*
