...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        if (!sPendingTransitions.contains(sceneRoot)) {
            ...
            Transition transitionClone = transition.mo58clone();
    ...
    public static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public void onViewDetachedFromWindow(View v) {
            ...
            if (runningTransitions != null && runningTransitions.size() > 0) {
                Iterator<Transition> it2 = runningTransitions.iterator();
                while (it2.hasNext()) {
                    Transition runningTransition = it2.next();
        ...
        public boolean onPreDraw() {
            ...
            if (previousRunningTransitions != null) {
                Iterator<Transition> it2 = previousRunningTransitions.iterator();
                while (it2.hasNext()) {
                    Transition runningTransition = it2.next();
                    runningTransition.resume(this.mSceneRoot);
                }
