...
public final class EntityDataTypes {
    public static final EntityDataType<EnumSet<EntityFlag>> FLAGS = new EntityDataType<EnumSet<EntityFlag>>(EnumSet.class, "FLAGS") { // from class: org.cloudburstmc.protocol.bedrock.data.entity.EntityDataTypes.1
        @Override // org.cloudburstmc.protocol.bedrock.data.entity.EntityDataType
