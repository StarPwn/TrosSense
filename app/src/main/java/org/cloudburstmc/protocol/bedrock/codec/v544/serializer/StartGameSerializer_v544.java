...
public class StartGameSerializer_v544 extends StartGameSerializer_v534 {
    ...
    @Override // org.cloudburstmc.protocol.bedrock.codec.v534.serializer.StartGameSerializer_v534, org.cloudburstmc.protocol.bedrock.codec.v465.serializer.StartGameSerializer_v465, org.cloudburstmc.protocol.bedrock.codec.v419.serializer.StartGameSerializer_v419
    protected void writeLevelSettings(ByteBuf buffer, BedrockCodecHelper helper, StartGamePacket packet) {
        ...
        helper.writeOptional(buffer, new StartGameSerializer_v407$$ExternalSyntheticLambda1(), packet.getForceExperimentalGameplay(), new BiConsumer() { // from class: org.cloudburstmc.protocol.bedrock.codec.v544.serializer.StartGameSerializer_v544$$ExternalSyntheticLambda0
    ...
    protected void readLevelSettings(ByteBuf buffer, BedrockCodecHelper helper, StartGamePacket packet) {
        ...
        packet.setForceExperimentalGameplay((OptionalBoolean) helper.readOptional(buffer, OptionalBoolean.empty(), new Function() { // from class: org.cloudburstmc.protocol.bedrock.codec.v544.serializer.StartGameSerializer_v544$$ExternalSyntheticLambda1
