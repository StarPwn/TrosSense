...
public class AddEntitySerializer_v557 extends AddEntitySerializer_v534 {
    ...
    public void serialize(ByteBuf buffer, BedrockCodecHelper helper, AddEntityPacket packet) {
        ...
        helper.writeArray(buffer, packet.getAttributes(), new TriConsumer() { // from class: org.cloudburstmc.protocol.bedrock.codec.v557.serializer.AddEntitySerializer_v557$$ExternalSyntheticLambda0
            @Override // org.cloudburstmc.protocol.common.util.TriConsumer
            public final void accept(Object obj, Object obj2, Object obj3) {
                AddEntitySerializer_v557.this.writeAttribute((ByteBuf) obj, (BedrockCodecHelper) obj2, (AttributeData) obj3);
            }
        });
    ...
    public void deserialize(ByteBuf buffer, BedrockCodecHelper helper, AddEntityPacket packet) {
        ...
        helper.readArray(buffer, packet.getAttributes(), new BiFunction() { // from class: org.cloudburstmc.protocol.bedrock.codec.v557.serializer.AddEntitySerializer_v557$$ExternalSyntheticLambda1
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
                return AddEntitySerializer_v557.this.readAttribute((ByteBuf) obj, (BedrockCodecHelper) obj2);
            }
        });
