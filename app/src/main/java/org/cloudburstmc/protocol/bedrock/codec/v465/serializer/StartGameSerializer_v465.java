...
public class StartGameSerializer_v465 extends StartGameSerializer_v440 {
    ...
    protected void writeLevelSettings(ByteBuf buffer, BedrockCodecHelper helper, StartGamePacket packet) {
        ...
        helper.writeOptional(buffer, new StartGameSerializer_v407$$ExternalSyntheticLambda1(), packet.getForceExperimentalGameplay(), new BiConsumer() { // from class: org.cloudburstmc.protocol.bedrock.codec.v465.serializer.StartGameSerializer_v465$$ExternalSyntheticLambda1
    ...
    protected void readLevelSettings(ByteBuf buffer, BedrockCodecHelper helper, StartGamePacket packet) {
        ...
        packet.setForceExperimentalGameplay((OptionalBoolean) helper.readOptional(buffer, OptionalBoolean.empty(), new Function() { // from class: org.cloudburstmc.protocol.bedrock.codec.v465.serializer.StartGameSerializer_v465$$ExternalSyntheticLambda0
