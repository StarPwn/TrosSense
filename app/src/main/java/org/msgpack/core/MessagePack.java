...
public class MessagePack {
    public static final Charset UTF8 = Charset.forName(StringUtil.UTF_8);
    ...
    public static class UnpackerConfig implements Cloneable {
        ...
        public int hashCode() {
            return ((((((((((((this.allowReadingStringAsBinary ? 1 : 0) * 31) + (this.allowReadingBinaryAsString ? 1 : 0)) * 31) + (this.actionOnMalformedString != null ? this.actionOnMalformedString.hashCode() : 0)) * 31) + (this.actionOnUnmappableString != null ? this.actionOnUnmappableString.hashCode() : 0)) * 31) + this.stringSizeLimit) * 31) + this.bufferSize) * 31) + this.stringDecoderBufferSize;
        }
