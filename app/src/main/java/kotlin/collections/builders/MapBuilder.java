...
public final class MapBuilder<K, V> implements Map<K, V>, Serializable, KMutableMap {
    ...
    public int hashCode() {
        int result = 0;
        EntriesItr it2 = entriesIterator$kotlin_stdlib();
        while (it2.hasNext()) {
            result += it2.nextHashCode$kotlin_stdlib();
        }
        return result;
    }
    ...
    private final void ensureCapacity(int capacity) {
        ...
        if (capacity > getCapacity$kotlin_stdlib()) {
            ...
            int computeHashSize = Companion.computeHashSize(capacity$kotlin_stdlib);
