...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final boolean copyRecursively(File $this$copyRecursively, File target, boolean overwrite, final Function2<? super File, ? super IOException, ? extends OnErrorAction> onError) {
        ...
        try {
            Iterator<File> it2 = FilesKt.walkTopDown($this$copyRecursively).onFail(new Function2<File, IOException, Unit>() { // from class: kotlin.io.FilesKt__UtilsKt$copyRecursively$2
    ...
    public static final boolean deleteRecursively(File $this$deleteRecursively) {
        ...
        for (Object element$iv : $this$fold$iv) {
            ...
            accumulator$iv = (it2.delete() || !it2.exists()) && res;
        }
