...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1500getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        return (((((int) ULong.m454constructorimpl(this.first ^ ULong.m454constructorimpl(this.first >>> 32))) * 31) + ((int) ULong.m454constructorimpl(this.last ^ ULong.m454constructorimpl(this.last >>> 32)))) * 31) + ((int) (this.step ^ (this.step >>> 32)));
    }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1526fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
