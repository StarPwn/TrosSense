...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x0014, code lost:            if (r2 >= 0) goto L11;     */
    /* JADX WARN: Code restructure failed: missing block: B:4:0x000d, code lost:            if (r2 <= 0) goto L11;     */
    /* JADX WARN: Code restructure failed: missing block: B:5:0x0017, code lost:            r0 = false;     */
    /*
    ...
    */
    private UIntProgressionIterator(int r4, int r5, int r6) {
        ...
        L18:
            r3.hasNext = r0
            int r0 = kotlin.UInt.m375constructorimpl(r6)
            r3.step = r0
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m369boximpl(m1518nextpVg5ArA());
    }
    ...
    public int m1518nextpVg5ArA() {
        ...
        if (value == this.finalElement) {
            ...
            this.next = UInt.m375constructorimpl(this.next + this.step);
        }
        return value;
    }
}
