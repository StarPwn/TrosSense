...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x0018, code lost:            if (r0 >= 0) goto L11;     */
    /* JADX WARN: Code restructure failed: missing block: B:4:0x0011, code lost:            if (r0 <= 0) goto L11;     */
    /* JADX WARN: Code restructure failed: missing block: B:5:0x001b, code lost:            r1 = false;     */
    /*
    ...
    */
    private ULongProgressionIterator(long r4, long r6, long r8) {
        ...
        L1c:
            r3.hasNext = r1
            long r0 = kotlin.ULong.m454constructorimpl(r8)
            r3.step = r0
    ...
    public /* bridge */ /* synthetic */ ULong next() {
        return ULong.m448boximpl(m1527nextsVKNKU());
    }
    ...
    public long m1527nextsVKNKU() {
        ...
        if (value == this.finalElement) {
            ...
            this.next = ULong.m454constructorimpl(this.next + this.step);
        }
        return value;
    }
}
