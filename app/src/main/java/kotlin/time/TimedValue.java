...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1763copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1765copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m1765copyRFiDyg4(T value, long duration) {
    ...
    public int hashCode() {
        return ((this.value == null ? 0 : this.value.hashCode()) * 31) + Duration.m1634hashCodeimpl(this.duration);
    }
    ...
    public final long m1766getDurationUwyO8pc() {
        return this.duration;
    }
