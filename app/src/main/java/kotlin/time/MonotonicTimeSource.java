...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public long m1739markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1748constructorimpl(read());
    }
    ...
    public final long m1737differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m1736adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1748constructorimpl(LongSaturatedMathKt.m1734saturatingAddpTJri5U(timeMark, duration));
    }
}
