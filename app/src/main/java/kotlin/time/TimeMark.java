...
public interface TimeMark {
    ...
    TimeMark mo1596minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1598plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1639isNegativeimpl($this.mo1595elapsedNowUwyO8pc());
        }
