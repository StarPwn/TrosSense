...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1596minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo1597minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1598plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1601minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo1598plusLRDsOJo(Duration.m1658unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1605compareToLRDsOJo($this.mo1597minusUwyO8pc(other), Duration.INSTANCE.m1708getZEROUwyO8pc());
        }
    }
}
