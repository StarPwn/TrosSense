...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0031, code lost:            return r4.subSequence(0, r2 + 1);     */
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0038, code lost:            return "";     */
    /* JADX WARN: Code restructure failed: missing block: B:2:0x0011, code lost:            if (r1 >= 0) goto L18;     */
    /* JADX WARN: Code restructure failed: missing block: B:3:0x0013, code lost:            r2 = r1;        r1 = r1 - 1;     */
    /* JADX WARN: Code restructure failed: missing block: B:4:0x0028, code lost:            if (r5.invoke(java.lang.Character.valueOf(r4.charAt(r2))).booleanValue() != false) goto L22;     */
    /* JADX WARN: Code restructure failed: missing block: B:5:0x0032, code lost:            if (r1 >= 0) goto L27;     */
    /*
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:11:0x0040, code lost:            return r3.toString();     */
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0038, code lost:            r3 = "";     */
    /* JADX WARN: Code restructure failed: missing block: B:2:0x0015, code lost:            if (r3 >= 0) goto L18;     */
    /* JADX WARN: Code restructure failed: missing block: B:3:0x0017, code lost:            r4 = r3;        r3 = r3 - 1;     */
    /* JADX WARN: Code restructure failed: missing block: B:4:0x002c, code lost:            if (r7.invoke(java.lang.Character.valueOf(r1.charAt(r4))).booleanValue() != false) goto L21;     */
    /* JADX WARN: Code restructure failed: missing block: B:5:0x0036, code lost:            if (r3 >= 0) goto L27;     */
    /* JADX WARN: Code restructure failed: missing block: B:9:0x002e, code lost:            r3 = r1.subSequence(0, r4 + 1);     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    public static final CharSequence trim(CharSequence $this$trim, char... chars) {
        ...
        while (startIndex$iv <= endIndex$iv) {
            int index$iv = !startFound$iv ? startIndex$iv : endIndex$iv;
            char it2 = $this$trim.charAt(index$iv);
            boolean match$iv = ArraysKt.contains(chars, it2);
            if (!startFound$iv) {
                if (match$iv) {
                    startIndex$iv++;
                } else {
    ...
    public static final String trim(String $this$trim, char... chars) {
        ...
        while (startIndex$iv$iv <= endIndex$iv$iv) {
            ...
            boolean match$iv$iv = ArraysKt.contains(chars, it2);
            if (!startFound$iv$iv) {
                if (match$iv$iv) {
                    startIndex$iv$iv++;
                } else {
    ...
    public static final CharSequence trimStart(CharSequence $this$trimStart, char... chars) {
        ...
        for (int index$iv = 0; index$iv < length; index$iv++) {
            char it2 = $this$trimStart.charAt(index$iv);
            if (!ArraysKt.contains(chars, it2)) {
    ...
    public static final String trimStart(String $this$trimStart, char... chars) {
        ...
        while (true) {
            if (index$iv$iv < length) {
                char it2 = $this$trimStart$iv$iv.charAt(index$iv$iv);
                if (ArraysKt.contains(chars, it2)) {
                    index$iv$iv++;
                } else {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:?, code lost:            return r6.subSequence(0, r3 + 1);     */
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0030, code lost:            return "";     */
    /* JADX WARN: Code restructure failed: missing block: B:2:0x0012, code lost:            if (r2 >= 0) goto L18;     */
    /* JADX WARN: Code restructure failed: missing block: B:3:0x0014, code lost:            r3 = r2;        r2 = r2 - 1;        r4 = r6.charAt(r3);     */
    /* JADX WARN: Code restructure failed: missing block: B:4:0x0020, code lost:            if (kotlin.collections.ArraysKt.contains(r7, r4) != false) goto L21;     */
    /* JADX WARN: Code restructure failed: missing block: B:5:0x002a, code lost:            if (r2 >= 0) goto L26;     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0034, code lost:            r0 = r4.toString();     */
    /* JADX WARN: Code restructure failed: missing block: B:11:0x0038, code lost:            return r0;     */
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0030, code lost:            r4 = "";     */
    /* JADX WARN: Code restructure failed: missing block: B:2:0x0016, code lost:            if (r4 >= 0) goto L18;     */
    /* JADX WARN: Code restructure failed: missing block: B:3:0x0018, code lost:            r5 = r4;        r4 = r4 - 1;        r6 = r2.charAt(r5);     */
    /* JADX WARN: Code restructure failed: missing block: B:4:0x0024, code lost:            if (kotlin.collections.ArraysKt.contains(r9, r6) != false) goto L21;     */
    /* JADX WARN: Code restructure failed: missing block: B:5:0x002e, code lost:            if (r4 >= 0) goto L27;     */
    /* JADX WARN: Code restructure failed: missing block: B:9:0x0026, code lost:            r4 = r2.subSequence(0, r5 + 1);     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:?, code lost:            return r6.subSequence(0, r3 + 1);     */
    /* JADX WARN: Code restructure failed: missing block: B:13:0x002b, code lost:            return "";     */
    /* JADX WARN: Code restructure failed: missing block: B:2:0x000d, code lost:            if (r2 >= 0) goto L18;     */
    /* JADX WARN: Code restructure failed: missing block: B:3:0x000f, code lost:            r3 = r2;        r2 = r2 - 1;        r4 = r6.charAt(r3);     */
    /* JADX WARN: Code restructure failed: missing block: B:4:0x001b, code lost:            if (kotlin.text.CharsKt.isWhitespace(r4) != false) goto L21;     */
    /* JADX WARN: Code restructure failed: missing block: B:5:0x0025, code lost:            if (r2 >= 0) goto L26;     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    public static final CharSequence padStart(CharSequence $this$padStart, int length, char padChar) {
        ...
        ?? it2 = new IntRange(1, length - $this$padStart.length()).iterator();
        while (it2.hasNext()) {
            it2.nextInt();
            sb.append(padChar);
        }
    ...
    public static final CharSequence padEnd(CharSequence $this$padEnd, int length, char padChar) {
        ...
        ?? it2 = new IntRange(1, length - $this$padEnd.length()).iterator();
        while (it2.hasNext()) {
            it2.nextInt();
            sb.append(padChar);
        }
    ...
    public static final int indexOfAny(CharSequence $this$indexOfAny, char[] chars, int startIndex, boolean ignoreCase) {
        ...
        ?? it2 = new IntRange(RangesKt.coerceAtLeast(startIndex, 0), StringsKt.getLastIndex($this$indexOfAny)).iterator();
        while (it2.hasNext()) {
            int index = it2.nextInt();
                ...
                while (true) {
                    ...
                    while (true) {
                        if (it2.hasNext()) {
                            ...
                            if (StringsKt.regionMatches(it3, 0, (String) $this$findAnyOf, index3, it3.length(), ignoreCase)) {
                                break;
                            }
                        } else {
                            element$iv2 = null;
                ...
                while (true) {
                    ...
                    while (true) {
                        if (it4.hasNext()) {
                            ...
                            if (StringsKt.regionMatchesImpl(it5, 0, $this$findAnyOf, index5, it5.length(), ignoreCase)) {
                                break;
                            }
                        } else {
                            element$iv = null;
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(CharSequence $this$rangesDelimitedBy, final char[] delimiters, int startIndex, final boolean ignoreCase, int limit) {
        ...
        return new DelimitedRangesSequence($this$rangesDelimitedBy, startIndex, limit, new Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>>() { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$1
            ...
            public final Pair<Integer, Integer> invoke(CharSequence $receiver, int currentIndex) {
                ...
                int it2 = StringsKt.indexOfAny($receiver, delimiters, currentIndex, ignoreCase);
                if (it2 < 0) {
                    return null;
                }
                return TuplesKt.to(Integer.valueOf(it2), 1);
            }
        });
    }
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(CharSequence $this$rangesDelimitedBy, String[] delimiters, int startIndex, final boolean ignoreCase, int limit) {
        ...
        return new DelimitedRangesSequence($this$rangesDelimitedBy, startIndex, limit, new Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>>() { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$2
            ...
            public final Pair<Integer, Integer> invoke(CharSequence $receiver, int currentIndex) {
                Pair it2;
                Intrinsics.checkNotNullParameter($receiver, "$this$$receiver");
                it2 = StringsKt__StringsKt.findAnyOf$StringsKt__StringsKt($receiver, delimitersList, currentIndex, ignoreCase, false);
                if (it2 != null) {
                    return TuplesKt.to(it2.getFirst(), Integer.valueOf(((String) it2.getSecond()).length()));
                }
                return null;
            }
        });
    ...
    public static final Sequence<String> splitToSequence(final CharSequence $this$splitToSequence, String[] delimiters, boolean ignoreCase, int limit) {
        ...
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default($this$splitToSequence, delimiters, 0, ignoreCase, limit, 2, (Object) null), new Function1<IntRange, String>() { // from class: kotlin.text.StringsKt__StringsKt$splitToSequence$1
            ...
            public final String invoke(IntRange it2) {
                ...
                return StringsKt.substring($this$splitToSequence, it2);
            }
        });
    }
    ...
    public static final List<String> split(CharSequence $this$split, String[] delimiters, boolean ignoreCase, int limit) {
        ...
        for (Object item$iv$iv : $this$map$iv) {
            IntRange it2 = (IntRange) item$iv$iv;
            destination$iv$iv.add(StringsKt.substring($this$split, it2));
        }
