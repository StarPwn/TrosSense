...
public final class Regex implements Serializable {
    ...
    */
    ...
    public final Set<RegexOption> getOptions() {
        ...
        Set it3 = Collections.unmodifiableSet(fromInt$lambda$1);
        Intrinsics.checkNotNullExpressionValue(it3, "unmodifiableSet(EnumSet.…mask == it.value }\n    })");
        this._options = it3;
        return it3;
    }
