...
public final class UStringsKt {
    ...
    public static final String m1592toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1594toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1593toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1591toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        return UByte.m292boximpl(UByte.m298constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m375constructorimpl(65535) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m375constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m375constructorimpl(result * uradix);
            result = UInt.m375constructorimpl(UInt.m375constructorimpl(digit) + result2);
            compare2 = Integer.compare(result ^ Integer.MIN_VALUE, result2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
        }
        return UInt.m369boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m454constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (compare > 0) {
                if (limitBeforeMul == 512409557603043100L) {
                    limitBeforeMul = BigArrays$$ExternalSyntheticBackport0.m(-1L, uradix);
            ...
            long result2 = ULong.m454constructorimpl(result * uradix);
            result = ULong.m454constructorimpl(ULong.m454constructorimpl(UInt.m375constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m448boximpl(result);
    }
}
