...
public final class UMathKt {
    ...
    private static final int m1504minJ1ME1BU(int a, int b) {
        return UComparisonsKt.m1486minOfJ1ME1BU(a, b);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m1505mineb3DHEI(long a, long b) {
        return UComparisonsKt.m1494minOfeb3DHEI(a, b);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m1502maxJ1ME1BU(int a, int b) {
        return UComparisonsKt.m1474maxOfJ1ME1BU(a, b);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m1503maxeb3DHEI(long a, long b) {
        return UComparisonsKt.m1482maxOfeb3DHEI(a, b);
    }
}
