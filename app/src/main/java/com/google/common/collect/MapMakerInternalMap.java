...
public class MapMakerInternalMap<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public E getEntry(@Nullable Object key) {
        if (key == null) {
            return null;
        }
        int hash = hash(key);
    ...
    public boolean containsValue(@Nullable Object obj) {
        ...
        while (i2 < 3) {
            ...
            for (int i3 = i; i3 < length; i3++) {
                StrongKeyStrongValueSegment strongKeyStrongValueSegment = segmentArr[i3];
                int i4 = strongKeyStrongValueSegment.count;
                ...
                for (int i5 = 0; i5 < atomicReferenceArray.length(); i5++) {
                    for (E e = atomicReferenceArray.get(i5); e != null; e = e.getNext()) {
                        Object liveValue = strongKeyStrongValueSegment.getLiveValue(e);
                        if (liveValue != null && valueEquivalence().equivalent(obj, liveValue)) {
                            return true;
                        }
                    }
                }
                j2 += strongKeyStrongValueSegment.modCount;
            }
            if (j2 != j) {
                j = j2;
                i2++;
