...
public class ImmutableListMultimap<K, V> extends ImmutableMultimap<K, V> implements ListMultimap<K, V> {
    ...
    public static <T, K, V> Collector<T, ?, ImmutableListMultimap<K, V>> toImmutableListMultimap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends V> valueFunction) {
        ...
        return Collector.of(new Supplier() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                return ImmutableListMultimap.builder();
            }
        }, new BiConsumer() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda5
        ...
        }, new BinaryOperator() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda6
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
                return ((ImmutableListMultimap.Builder) obj).combine((ImmutableMultimap.Builder) obj2);
            }
        }, new Function() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda7
    ...
    public static <T, K, V> Collector<T, ?, ImmutableListMultimap<K, V>> flatteningToImmutableListMultimap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends Stream<? extends V>> valuesFunction) {
        ...
        Function function = new Function() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda0
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Object checkNotNull;
        ...
        Function function2 = new Function() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda1
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Stream peek;
        ...
        return Collectors.collectingAndThen(Multimaps.flatteningToMultimap(function, function2, new Supplier() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return MultimapBuilder.ListMultimapBuilder.this.build();
            }
        }), new Function() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda3
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
