...
public class FloatingActionButtonImpl {
    ...
    public void hide(final InternalVisibilityChangedListener listener, final boolean fromUser) {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            if (this.hideListeners != null) {
                ...
                while (it2.hasNext()) {
                    Animator.AnimatorListener l = it2.next();
                    set.addListener(l);
                }
            }
            set.start();
    ...
    public void onTranslationChanged() {
        if (this.transformationCallbacks != null) {
            Iterator<InternalTransformationCallback> it2 = this.transformationCallbacks.iterator();
            while (it2.hasNext()) {
                InternalTransformationCallback l = it2.next();
