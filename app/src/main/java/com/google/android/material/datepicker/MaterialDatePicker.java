...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.confirmButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.1
            ...
            public void onClick(View v) {
                ...
                while (it2.hasNext()) {
                    MaterialPickerOnPositiveButtonClickListener<? super S> listener = (MaterialPickerOnPositiveButtonClickListener) it2.next();
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.2
            ...
            public void onClick(View v) {
                ...
                while (it2.hasNext()) {
                    View.OnClickListener listener = (View.OnClickListener) it2.next();
                    listener.onClick(v);
                }
                MaterialDatePicker.this.dismiss();
            }
    ...
    public final void onCancel(DialogInterface dialogInterface) {
        ...
        while (it2.hasNext()) {
            DialogInterface.OnCancelListener listener = it2.next();
    ...
    public final void onDismiss(DialogInterface dialogInterface) {
        ...
        while (it2.hasNext()) {
            DialogInterface.OnDismissListener listener = it2.next();
    ...
    private void initHeaderToggle(Context context) {
        ...
        this.headerToggleButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                MaterialDatePicker.this.m112x8a93f18a(view);
            }
        });
    }
    ...
    public /* synthetic */ void m112x8a93f18a(View v) {
