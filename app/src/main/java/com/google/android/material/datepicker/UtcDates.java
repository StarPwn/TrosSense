...
class UtcDates {
    ...
    public static String getDefaultTextInputHint(Resources res, SimpleDateFormat format) {
        ...
        if (Locale.getDefault().getLanguage().equals(Locale.KOREAN.getLanguage())) {
            formatHint = formatHint.replaceAll("d+", "d").replaceAll("M+", "M").replaceAll("y+", EllipticCurveJsonWebKey.Y_MEMBER_NAME);
        }
        return formatHint.replace("d", dayChar).replace("M", monthChar).replace(EllipticCurveJsonWebKey.Y_MEMBER_NAME, yearChar);
    }
