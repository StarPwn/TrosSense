...
public final class ColorResourcesTableCreator {
    ...
    public static class PackageChunk {
        ...
        void writeTo(ByteArrayOutputStream outputStream) throws IOException {
            ...
            outputStream.write(ColorResourcesTableCreator.intToByteArray(bl.dY));
            outputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            outputStream.write(ColorResourcesTableCreator.intToByteArray(this.typeStrings.getChunkSize() + bl.dY));
            outputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            outputStream.write(ColorResourcesTableCreator.intToByteArray(0));
        ...
        int getChunkSize() {
            return this.typeStrings.getChunkSize() + bl.dY + this.keyStrings.getChunkSize() + this.typeSpecChunk.getChunkSizeWithTypeChunk();
        }
    }
    ...
    public static byte[] shortToByteArray(short value) {
        return new byte[]{(byte) (value & Http2CodecUtil.MAX_UNSIGNED_BYTE), (byte) ((value >> 8) & 255)};
    }
    ...
    public static byte[] stringToByteArrayUtf8(String value) {
        byte[] rawBytes = value.getBytes(Charset.forName(StringUtil.UTF_8));
