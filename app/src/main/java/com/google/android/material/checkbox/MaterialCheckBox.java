...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public void setCheckedState(int checkedState) {
        ...
        if (this.checkedState != checkedState) {
            ...
            if (this.onCheckedStateChangedListeners != null) {
                Iterator<OnCheckedStateChangedListener> it2 = this.onCheckedStateChangedListeners.iterator();
                while (it2.hasNext()) {
                    OnCheckedStateChangedListener listener = it2.next();
    ...
    public void setErrorShown(boolean errorShown) {
        ...
        while (it2.hasNext()) {
            OnErrorChangedListener listener = it2.next();
